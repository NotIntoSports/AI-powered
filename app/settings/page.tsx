...
type Diagnostics = { server: boolean; modelConfigured: boolean; stageConnected: boolean; ttsSupported: boolean; voiceCount: number; sapiConfigured: boolean; sapiVoiceCount: number; ttsState: "idle" | "speaking" | "ready" | "error"; ttsError: string; lastSpeechAt: number; mediaReady: boolean; transcriptionConfigured: boolean; transcriptionReady: boolean; transcriptionSource: "volcengine" | "management" | "environment" | "whisper-cpp" | "none" };
...
export default function SettingsPage() {
  ...
  return <main className="console settingsPage">
    ...
    <section className="settingsGrid">
      ...
      <SettingSection number="03" title="面试官声音" detail="用真实麦克风按稿录音，完成火山声音刻录后舞台用该音色说话。">
        <VoiceCloneControl />
      </SettingSection>
