...
- [ ] **Step 1: Write failing Rust and frontend contract tests**
...
- [ ] **Step 3: Implement contracts and thin command**
...
- [ ] **Step 4: Generate bindings through a deterministic test**
...
- [ ] **Step 5: Implement the only frontend invoke wrapper**
...
- [ ] **Step 6: Verify contract generation and drift check**
